...
for($i=0; $i<$noOfPntrs; $i++){
    $currentOffset = hexdec('41000')+($i*4);
...
$pntrArray[] = '009622B'; // because last length info is missing, add this one manually
