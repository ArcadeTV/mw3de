...
base_PointerTable_SpecialDialogues:
                                                     ...
                                                     ; ˅       ˅            ˅
    dc.w special1-base_PointerTable_SpecialDialogues ; FBB4 => 044C         21B7E-21CC5
    dc.w special2-base_PointerTable_SpecialDialogues ; FCFC => 0304         21CC6-21E6B
    dc.w special3-base_PointerTable_SpecialDialogues ; FEA2 => 015E         21E6C-21EF3
    ...
    dc.w special8-base_PointerTable_SpecialDialogues ; FF6D => 0093         21F37-21FC9
